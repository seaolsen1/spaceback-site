    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          ...
          priority
        />
        <div className="absolute bottom-4 right-4 bg-green-600 text-white px-3 py-1.5 rounded-full text-sm font-medium tracking-wide">
          After
        </div>
      </div>
      ...
      >
        <Image
          ...
          priority
        />
        <div className="absolute bottom-4 left-4 bg-red-600 text-white px-3 py-1.5 rounded-full text-sm font-medium tracking-wide">
          Before
        </div>
      </div>
